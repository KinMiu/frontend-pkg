...
const DosenChangePassword: React.FC = () => {
      ...
      <div className="mb-6 rounded-lg bg-white p-6 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Password tersimpan di database dan dipakai saat login berikutnya.</p>
          </div>
        </div>
      </div>
...
export default DosenChangePassword;
